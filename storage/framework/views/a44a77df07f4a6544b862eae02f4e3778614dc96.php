<form action="<?php echo e(isset($producto) ? route('productos.update', $producto->product_code) : route('productos.store')); ?>"
    ...
    <div class="col-span-2">
        ...
        <input type="text" name="product_name"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['product_name'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <select name="id_category" class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['id_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
            ...
            <?php if(isset($categoryOptions)): ?>
                <?php $__currentLoopData = $categoryOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" step="0.01" name="price"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" step="0.01" name="discount"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['discount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" name="available_unity"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['available_unity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" name="minimum_stock"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['minimum_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" name="maximum_stock"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['maximum_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <select name="status" class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <input type="number" name="display_order"
               ...
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['display_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-span-2">
        ...
        <textarea name="description"
                  class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-span-2">
        ...
        <textarea name="ingredients"
                  class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['ingredients'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-span-2">
        ...
        <input type="file" name="image"
               class="w-full border rounded-lg px-3 py-2 <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-span-2 flex justify-end">
        <button type="submit" class="px-4 py-2 rounded-lg flex items-center bg-pink-400 text-white py-2 rounded hover:bg-pink-500 cursor-pointer">
            <?php echo e(isset($producto) ? 'Actualizar' : 'Guardar'); ?>

        </button>
    </div>
</form>
<?php /**PATH C:\xampp\htdocs\FluffyBakery\FluffyBakery\resources\views/admin/productos/form.blade.php ENDPATH**/ ?>