    ...
    <div class="container mx-auto px-4">
        ...
        <div id="mobileMenu" class="md:hidden hidden pb-4 transition-all">
            <div class="flex flex-col space-y-2">
                ...
                <a href="#" class="nav-link py-2">Contáctenos</a>
            </div>
        </div>
    </div>
</nav>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block mb-1 font-semibold">Confirmar Password</label>
...
</style><?php /**PATH C:\xampp\htdocs\FluffyBakery\FluffyBakery\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>