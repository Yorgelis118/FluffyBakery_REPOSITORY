    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                <img src="<?php echo e(asset('storage/products/'.$producto->image)); ?>" 
                ...
                <div class="p-4">
                    ...
                    <p class="mt-2 font-bold text-pink-600">$<?php echo e(number_format($producto->price, 2)); ?></p>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p class="col-span-4 text-center text-gray-500">No hay productos disponibles en esta categoría.</p>
        <?php endif; ?>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\FluffyBakery\resources\views/users/productos.blade.php ENDPATH**/ ?>