               ...
               <!-- Item 1-->
                <div class="duration-700 ease-in-out h-full" data-carousel-item>
                    <div class="relative w-full h-full">
                        <img src="<?php echo e(asset('img/galletasyvelas.jpeg')); ?>" class="absolute inset-0 z-0 w-full h-full object-cover object-center" alt="...">
                        <div class="absolute inset-0 z-10 bg-gray-900/30 flex items-center justify-center">
                            <div class="max-w-3xl mx-auto w-full text-center px-6">
                                ...
                                <br><br>
                                <a href="<?php echo e(url('productos#galletas')); ?>" class="inline-block mt-4 md:mt-6 px-5 py-2 md:px-6 md:py-3 bg-pink-600 text-white rounded-lg shadow hover:bg-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-400">
                                    Ver galletas
                                </a>
                            </div>
                        </div>
                ...
                <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
                    <div class="relative w-full h-full">
                        <img src="<?php echo e(asset('img/torta2-1.jpeg')); ?>" class="absolute inset-0 z-0 bg-cover w-full h-full object-center" alt="...">
                        <div class="absolute inset-0 z-10 bg-gray-900/30 flex items-center justify-center">
                            <div class="max-w-3xl mx-auto w-full text-center px-6">
                ...
                <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
                    <div class="relative w-full h-full">
                        <img src="<?php echo e(asset('img/brownieoscuro1.jpeg')); ?>" class="absolute inset-0 z-0 w-full h-full object-cover object-center" alt="...">
                        <div class="absolute inset-0 z-10 bg-gray-900/30 flex items-center justify-center">
                        <div class="max-w-3xl mx-auto w-full text-center px-6">
                ...
                <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
                    <div class="relative w-full h-full">
                        <img src="<?php echo e(asset('img/cupcakesx3.jpeg')); ?>" class="absolute inset-0 z-0 w-full h-full object-cover object-center" alt="...">
                        <div class="absolute inset-0 z-10 bg-gray-900/30 flex items-center justify-center">
                        <div class="max-w-3xl mx-auto w-full text-center px-6">
                ...
                <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
                    <div class="relative w-full h-full">
                        <img src="<?php echo e(asset('img/alfajoresmodelo2.jpeg')); ?>" class="absolute inset-0 z-0 w-full h-full object-cover object-center" alt="...">
                        <div class="absolute inset-0 z-10 bg-gray-900/30 flex items-center justify-center">
                        <div class="max-w-3xl mx-auto w-full text-center px-6">
...
<section class="py-16 bg-gray-100">
    <div class="container mx-auto px-6 flex flex-col md:flex-row items-center gap-4">
        ...
        <div class="gap-10 flex justify-center md:justify-end">
            <img src="<?php echo e(asset('img/galletapiedelimon1.jpeg')); ?>" alt="Galleta Pie de Limón" class="rounded shadow-lg w-80 h-80 object-cover">
        </div>
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-6 flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-6 md:mb-0">
                    <img src="<?php echo e(asset('img/todasgalletasgeneral.jpeg')); ?>" alt="Quiénes Somos" class="rounded shadow-lg mx-auto w-64 h-64 object-cover rounded">
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FluffyBakeryV2-carrito1\FluffyBakery\resources\views/users/indexgeneral.blade.php ENDPATH**/ ?>