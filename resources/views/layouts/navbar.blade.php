            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative inline-block text-left">
                    ...
                    <div id="userDropdownMenu"
                        ...
                        @auth
                            <span class="block px-4 py-2 text-gray-600">Hola, {{ Auth::user()->name }}</span>
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="{{ route('users.productos') }}" class="nav-link">Productos</a>
            </div>
        ...
        <div id="mobileMenu" class="md:hidden hidden pb-4 transition-all">
            <div class="flex flex-col space-y-2">
                <a href="{{ route('inicio') }}" class="nav-link py-2">Inicio</a>
                <a href="{{ route('users.productos') }}" class="nav-link py-2">Productos</a>
                ...
                <div class="bg-white border border-pink-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h6 class="text-sm font-semibold text-gray-900 truncate">{{ $nombre }}</h6>
                            <p class="text-sm text-pink-600 font-medium">${{ number_format($precio, 2) }}</p>
                        </div>
                        
                        <!-- Controles de cantidad -->
                        <div class="flex items-center space-x-2">
                            <button onclick="actualizarCantidad({{ $keyProducto }}, {{ $cantidad - 1 }})" 
                            ...
                            <span class="w-8 text-center font-semibold text-gray-700">{{ $cantidad }}</span>
                            <button onclick="actualizarCantidad({{ $keyProducto }}, {{ $cantidad + 1 }})" 
                                    class="w-8 h-8 bg-pink-100 text-pink-600 rounded-full flex items-center justify-center hover:bg-pink-200 transition-colors">
                        ...
                        <div class="text-right">
                            <p class="text-sm font-bold text-gray-900">${{ number_format($subtotal, 2) }}</p>
                        </div>
                        
                        <!-- Botón eliminar -->
                        <button onclick="eliminarDelCarrito({{ $keyProducto }})" 
